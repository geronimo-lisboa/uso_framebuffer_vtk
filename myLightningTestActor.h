...
class myLightiningTestActor :public vtkProp3D {
private:
	...
	GLuint vao, vertexesVbo, texCoordsVbo, normalsVbo; //O vertex array object e o vertex buffer object.
